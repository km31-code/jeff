...
use crate::{
    awareness_core, consolidation, context_observer, goal_extraction, memory, relational_model,
    speculation, state, work_understanding,
};
...
pub async fn spawn_memory_session_summary_poll(handle: tauri::AppHandle) {
...
pub async fn spawn_memory_consolidation_poll(handle: tauri::AppHandle) {
